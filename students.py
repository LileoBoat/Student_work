...
student6 = Student("George", 222222, "Mathematics", 3.89, False)
...
print(student1.valedictorian())
print(student2.valedictorian())
print(student3.valedictorian())
print(student4.valedictorian())
print(student5.valedictorian())
print(student6.valedictorian())
print(student7.valedictorian())
